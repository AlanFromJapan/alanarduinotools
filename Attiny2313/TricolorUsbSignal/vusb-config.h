...
/*
const PROGMEM char usbHidReportDescriptor[35 + 6 + 18] = {   // USB report descriptor 
    ...
    0x95, 0x01,                    //   REPORT_COUNT (1)
    0x75, 0x08,                    //   REPORT_SIZE (8)
//    0x15, 0x00,                    //   LOGICAL_MINIMUM (0) //if you add this it doesn't work
