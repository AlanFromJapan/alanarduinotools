...
(extract from USB-IDs-for-free.txt)
*/
 ...
 */
#define  USB_CFG_DEVICE_ID       0xdf, 0x06
 ...
 */
#define USB_CFG_VENDOR_NAME    'e','l','e','c','t','r','o','g','e','e','k','.','c','c'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'A','l','a','n',' ','U','S','B',' ','v','o','l','u','m','e',' ','c','o','n','t','r','o','l','l','e','r'
