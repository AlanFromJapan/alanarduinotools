...
#define ALARM_LENGTH 30000 //30 sec
#define ALARM_SNOOZE_COUNT 3 //snooze 5 times before dropping the alarm 
#define ALARM_SNOOZE_DURATION 2 //snooze 5 minutes
...
void setup() { 
  ...
  EEPROM.write(EEPROM_ADDR_HOUR, 7);
