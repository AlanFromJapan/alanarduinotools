...
char* getDateDs1307(char* pBuff, Date& pD)
{
  ...
  //offsetting
  int vMinutesRaw = pD.minute + mDateOffsetInMinutes;
...
void saveEEPROMOffset (){ saveEEPROMOffset(mDateOffsetInMinutes); }
...
void setup() { 
  ...
  */
  ...
  Serial.println("Here under, the offset:");
  Serial.print(mDateOffsetInMinutes,DEC);
  Serial.println("");
#endif
