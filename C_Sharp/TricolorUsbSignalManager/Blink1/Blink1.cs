...
namespace ThingM.Blink1
{
    ...
    public class Blink1 : IDisposable, IBlink1
    {
        ...
        public void Open()
        {
            this.Open(Blink1Constant.VendorId, Blink1Constant.ProductId);
        }
        ...
        ///     Open a connection to the first Blink(1) device available.
        /// </summary>
        public void Open(int pVendorId, int pProductID) {
            this.hidDevice = HidDevices.Enumerate(pVendorId, pProductID).FirstOrDefault();
        ...
        public bool SendRawBuffer(byte[] pBuff) {
            if (this.IsConnected == false) {
                throw new InvalidOperationException("No Blink(1) device connected.");
            }
            ...
            Array.Copy(pBuff, buffers, pBuff.Length);
